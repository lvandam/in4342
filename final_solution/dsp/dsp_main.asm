...
;* Date/Time created: Sun Jun 11 14:10:58 2017                                *
;******************************************************************************
...
$C$DW$14	.dwtag  DW_TAG_variable, DW_AT_name("MPCSXFER_BufferSize")
	...
	.bss	_MPCSXFER_NumIterations,4,4
...
;	/opt/bbToolChain/usr/local/share/c6000/bin/opt6x /tmp/02696q7KIwB /tmp/02696g0aKfu 
	.sect	".text"
	.clink
	.global	_main
...
||         STW     .D2T1   A3,*+DP(_MPCSXFER_BufferSize) ; |313| 
