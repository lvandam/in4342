...
;	/opt/bbToolChain/usr/local/share/c6000/bin/acp6x -@/tmp/1756977Zgxe 
	.sect	".text"
	.clink
...
$C$DW$120	.dwtag  DW_TAG_TI_loop
	.dwattr $C$DW$120, DW_AT_name("/home/constantinos/embLab/handing/dsp/task.asm:$C$L7:1:1497059572")
